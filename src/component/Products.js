              ...
              return (
                <Grid item key={index}>
                  <Card style={{ width: '25rem', height: '35rem' }}>
                    ...
                    <CardActions>
                      <IconButton style={{ fontSize: '1.2rem', color: '#586a89' }} disabled={product.inStock > 0 ? false : true}>Add to cart</IconButton>
                      <IconButton component={Link} to={`/details/${product._id}`} style={{ fontSize: '1.2rem', color: '#586a89' }}>View details</IconButton>
                    </CardActions>
                  </Card>
                </Grid>
              )
